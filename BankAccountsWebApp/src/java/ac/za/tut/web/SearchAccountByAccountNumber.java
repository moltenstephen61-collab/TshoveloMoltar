 ...
 */
public class SearchAccountByAccountNumber extends HttpServlet {
    @EJB
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //
        request.getRequestDispatcher("search_by_account_number_outcome.jsp").forward(request, response);
    }
}
