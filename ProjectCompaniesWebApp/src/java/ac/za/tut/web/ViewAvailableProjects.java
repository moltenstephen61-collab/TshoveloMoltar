 ...
 */
public class ViewAvailableProjects extends HttpServlet {
     @EJB
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // 1. Fetch all companies from the database via the EJB
    ...
    request.getRequestDispatcher("view_projects_outcome.jsp").forward(request, response);
